const REPORT_STRUCTURE = [
    // --- SECTION 0: IDENTIFICATION ---
    {
        id: 'identification',
        name: 'Identification',
        description: "This webpage is for Voluntary Observing Ships to compile FM13 SHIP weather reports. Follow the steps to complete the reports. Some steps can be skipped. At the end you will be redirected to send the report via email. Inputs with a green bar on the left, such as call sign, are cached. When reloading the page, the numbers will be automatically loaded. For any suggestions and feedbacks, please send them to hkopmo@hko.gov.hk (this is NOT the report recipient address).",
        section: 0,
        mandatory: true,
        wmoOrder: 0,
        fields: [
